...
- Cache Top-File ([link](https://github.com/EIE2-IAC-Labs/iac-riscv-cw-14/tree/4728a76a099dfc7747696fc99333d4fe5a529c0d), in cache-pipelining-playground branch)
...
-----
- The first special design decision was also to implement branch instructions within the ALU. These instructions would be processed at the same time as the ALU instructions, with more simple implementations of the branch logic using the ALU to test for specific conditions, such as Less Than. To simplify the top-level design and provide the option of increasing the efficiency of the branch logic relative to logic components used, I decided to keep this within the ALU block.
...
The implementation of multiply, divide and an FPU to handle floats would make the CPU more usable for real-world applications. The expansion to the 64-bit ISA would allow more addressable memory, however this is unrealistic for the simple test-programs written.
